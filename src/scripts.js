...
function renderHome(){
  ...
  body.innerHTML=
    ...
    homeCard+
    (function(){if(new Date()>=new Date("2026-06-06T11:00:00Z"))return"";var m={"en":"⚠️ Jun 4 update — Revolut stage shows cancelled due to weather. Some set times also changed.<br>Sorry for the delay, I was at the venue, got caught in the rain, and only had time to update just now.<br>Stay safe tonight and have fun!","es":"⚠️ Actualización 4 jun — Los conciertos del escenario Revolut cancelados por el mal tiempo. Algunos horarios también han cambiado.<br>Perdón por el retraso, estaba en el recinto, me pilló la lluvia y solo he podido actualizar ahora.<br>¡Que estéis seguros esta noche y a disfrutar!","ca":"⚠️ Actualització 4 jun — Els concerts de l'escenari Revolut cancel·lats per mal temps. Alguns horaris també han canviat.<br>Perdoneu el retard, era al recinte, em va agafar la pluja i només ara he pogut actualitzar.<br>Aneu amb compte aquesta nit i gaudiu-ne!","zh":"⚠️ 6月4日更新 — Revolut 舞台演出因天气原因全部取消。部分演出时间也有变动。<br>抱歉更新晚了，我在现场被雨淋了堵在路上，现在才有时间更新。<br>请大家今晚注意安全，玩得开心！","zht":"⚠️ 6月4日更新 — Revolut 舞台演出因天氣問題全部取消。部分演出時間都有變動。<br>遲咗更新唔好意思，我喺現場俾雨淋濕咗，而家先有時間更新。<br>今晚注意安全，玩得開心！"};return'<div class="home-banner">'+(m[curLang]||m.en)+'</div>';})()+
    '<div class="home-nav">'+
