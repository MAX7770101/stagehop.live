...
function renderHome(){
  ...
  body.innerHTML=
    ...
    (function(){var m={"en":"📢 Refund update — Thursday ticket refunds will be processed. Details on how to claim will be announced on Monday by the festival.","es":"📢 Actualización de reembolsos — Se procesarán los reembolsos de las entradas del jueves. El festival anunciará el lunes los detalles sobre cómo reclamarlos.","ca":"📢 Actualització de reemborsaments — Es processaran els reemborsaments de les entrades del dijous. El festival anunciarà dilluns els detalls sobre com reclamar-los.","zh":"📢 退票更新 — 周四门票将予以退款。退款申请方式将由音乐节在周一公布。","zht":"📢 退票更新 — 周四門票將予以退款。退款申請方式將由音樂節喺周一公布。"};return'<div class="home-banner">'+(m[curLang]||m.en)+'</div>';})()+
    '<div class="home-nav">'+
