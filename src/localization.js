...
var LANGS={
  ...
  ca:{
    ...
    doorsH:"Horaris d'obertura",doorsBody:"El Parc del Fòrum obre cada dia cap a les 16:00, els concerts continuen fins a les 05:00–06:00. El dimecres d'obertura (3/6) és gratuït des de les ~17:00 a l'escenari del front marítim.",
    transitH:"Com arribar-hi",metroLine:"Metro L4 (línia groga)",metroStop:"Parada El Maresme | Fòrum",
    nightbus:"Autobús nocturn N6",nightbusDesc:"Servei nocturn un cop tancat el metro, cada ~15 min fins al centre",
    bikeDesc:"Aparcament de bicicletes gratuït al recinte",metroHours:"Dl–Dj 05:00–00:00 · Dv 05:00–02:00 · Ds servei continu 24h",tramLine:"Tramvia T4",tramStop:"Parada Fòrum · Servei reforçat durant el festival",daybus:"Autobusos diürns H16 / H14 / 143 / 7 / 36",daybusDesc:"Des de diverses zones del centre, 06:30–23:15",shuttle:"Bus llançadora oficial",shuttleDesc:"~€2 per trajecte de mitjanit a l'alba, Passeig Taulat → Plaça Catalunya. Reserva a l'app AccessTicket",walkDesc:"~60 min a peu des del centre per la rambla del mar amb vistes al Mediterrani",
    banH:"Objectes prohibits",
    banItems:["Recipients de vidre","Càmera professional/de vídeo (DSLR; compactes i analògiques OK)","Pals selfie","Drons","Mascotes (excepte gossos pigall)"],
    allowItems:["Menjar (no en recipients de vidre)","Aigua en ampolla de plàstic ≤50cl (sense tap a l'entrada)","Got de plàstic propi ≤40cl","Càmera analògica, compacta o d'un sol ús","Bossa petita (fins a mida A4)","Impermeable / protector solar","Medicació amb recepta (amb documentació)"],
    ...
    tips:["La polsera AccessTicket s'ha d'activar a l'entrada — deixa temps per fer cua","Punts de recàrrega en efectiu distribuïts pel recinte (pagament AccessTicket)","Fonts d'aigua gratuïtes per tot el recinte","El punt Nobody Is Normal ofereix assistència d'emergència"],
    ticketsH:"Entrades",
